...
<link href="<?php echo base_url(); ?>assets/player/video-js-7.8.4/video-js.min.css" rel="stylesheet" type="text/css">
<link href="<?php echo base_url(); ?>assets/player/plugins/videojs-mobile-ui/videojs-mobile-ui.css" rel="stylesheet" type="text/css">
<!-- tube skin CSS -->
<link href="<?php echo base_url(); ?>assets/player/plugins/tube-skin/tube.css" media="only screen and (min-width: 820px)" rel="stylesheet"/> 
<script src="<?php echo base_url(); ?>assets/player/video-js-7.8.4/video.min.js" crossorigin="anonymous"></script>
...
<!-- Video Js Doc  -->
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/player/plugins/videojs-dock/videojs-dock.css">
<!-- UP-NEXT  -->
<link href="<?php echo base_url(); ?>assets/player/plugins/videojs-upnext/dist/videojs-upnext.min.css" rel="stylesheet">
<!-- chromecast sdk -->
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-170866346-1"></script>
