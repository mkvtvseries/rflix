        ...
        <div class="col-md-12">
          <div>
            ...
            <button type="submit" id="paypal-btn" class="paypal-buy-now-button" disabled formaction="<?php echo base_url('subscription/paypal/process');?>">
             ...
             <button type="submit" id="local-btn" class="btn btn-success btn-stripe clearfix" disabled formaction="<?php echo base_url('/payment');?>"><?php echo trans("local_payment");?></button> 
